...
let cloudfrontPrompt = async () => {
  let answers = await inquirer.prompt([
    {
      name: "cloudfront_compress",
      message: "Cloudfront - Compress objects?",
      default: true,
      type: "confirm",
    }, {
      name: "cloudfront_https",
      message: "CloudFront - HTTPS Policy",
      type: "list",
      default: "redirect-to-https",
      choices: [
        { name: "Accept both HTTP and HTTPS", value: "allow-all" },
...
module.exports = async () => {
  ...
  if (configuration.cloudfront) {
    configuration = Object.assign(configuration, await cloudfrontPrompt())
  }
